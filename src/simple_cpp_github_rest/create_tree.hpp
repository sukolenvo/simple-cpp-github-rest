...
template<> struct glz::meta<simple_cpp::github_rest::CreateTreeEntry>
{
  ...
  static constexpr auto value = object(
    "path", &simple_cpp::github_rest::CreateTreeEntry::path,
    "mode", &simple_cpp::github_rest::CreateTreeEntry::mode,
    "content", &simple_cpp::github_rest::CreateTreeEntry::content
  );
};
...
template<> struct glz::meta<simple_cpp::github_rest::CreateTreeRequestBody>
{
  ...
  static constexpr auto value = object(
    "tree", &simple_cpp::github_rest::CreateTreeRequestBody::tree,
    "base_tree", &simple_cpp::github_rest::CreateTreeRequestBody::base_tree
  );
};
