...
template<> struct glz::meta<simple_cpp::github_rest::UpdateReferenceRequestBody>
{
  using T = simple_cpp::github_rest::UpdateReferenceRequestBody;
  static constexpr auto value = object("sha", &simple_cpp::github_rest::UpdateReferenceRequestBody::sha);
};
